...
def main():
    ...
    pygame.display.set_caption("Ping Pong (CV+Pygame)")
    font = pygame.font.SysFont("Arial", 36)
    clock = pygame.time.Clock()
    with tracer.start_as_current_span("pingpong_session"):
        running = True
        while running:
            _, img = cap.read()
            img = cv2.flip(img, 1)
                ...
                for hand in hands:
                    ...
                    if hand['type'] == "Left":
                        ...
                        if 59 < ballPos[0] < 59 + w1 and y1 < ballPos[1] < y1 + h1:
                            ...
                            ballPos[0] += 30
                            score[0] += 1
                            with tracer.start_as_current_span("bat_hit_left"):
                                pass
                    if hand['type'] == "Right":
                        ...
                        if 1195 - 50 < ballPos[0] < 1195 and y1 < ballPos[1] < y1 + h1:
                            ...
                            ballPos[0] -= 30
                            score[1] += 1
                            with tracer.start_as_current_span("bat_hit_right"):
                                pass
