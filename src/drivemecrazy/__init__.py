...
pygame.display.set_caption('Drive Simulator (CV+Pygame)')
font = pygame.font.SysFont("Arial", 32)
clock = pygame.time.Clock()
with tracer.start_as_current_span("drive_session"):
    running = True
    while running:
        ...
        display = np.full((height, width, 3), (30, 30, 30), dtype=np.uint8)
        ...
        surf = pygame.surfarray.make_surface(display_rgb.swapaxes(0, 1))
        screen.blit(surf, (0, 0))
        instr = font.render("Steer with both hands like a wheel! Press 'q' to quit.", True, (255,255,255))
