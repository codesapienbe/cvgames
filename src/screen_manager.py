...
class ScreenManager:
    ...
    def initialize(self, title="Game Window", fullscreen=True, force_resolution=None):
        """Initialize pygame and setup proper screen resolution with DPI awareness"""
        ...
        if force_resolution:
            ...
            logger.info("Using config manager resolution", extra={"resolution": f"{self.display_width}x{self.display_height}"})
        else:
